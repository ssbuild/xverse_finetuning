...
```text 
    ...
    08-25 support xverse chat
    08-08 初始化xerse finetuning deep_training 版本 0.1.15.rc2
...
支持且不限于以下权重    
- [XVERSE-65B-Chat](https://huggingface.co/xverse/XVERSE-65B-Chat)
- [XVERSE-7B-Chat](https://huggingface.co/xverse/XVERSE-7B-Chat)
...
- [chatglm2_finetuning](https://github.com/ssbuild/chatglm_finetuning)
...
[![Star History Chart](https://api.star-history.com/svg?repos=ssbuild/xverse_finetuning&type=Date)](https://star-history.com/#ssbuild/xverse_finetuning&Date)